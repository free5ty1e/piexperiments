...
chromium-browser https://www.robinhood.com/ --new-window --window-position="74,66" --window-size="1846,1008" --force-device-scale-factor=1.75 --noerrdialogs --allow-running-insecure-content --remember-cert-error-decisions &
